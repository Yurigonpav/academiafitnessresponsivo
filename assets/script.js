window.onscroll = function() {
  var bmiSection = document.querySelector('.bmi-calculator');
  var footer = document.querySelector('footer');
  var rect = bmiSection.getBoundingClientRect();
  var isVisible = rect.top < window.innerHeight && rect.bottom >= 0;
  // Atualize a visibilidade do footer com base na condição acima
  if (isVisible) {
